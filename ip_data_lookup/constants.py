...
DEFAULT_SETTINGS = {
    CHECKBOXES_SETTING_SECTION_NAME: {
        COUNTRY_SETTING_LOCATOR[1]: True,
        COUNTRY_CODE_SETTING_LOCATOR[1]: True,
        REGION_SETTING_LOCATOR[1]: True,
        REGION_NAME_SETTING_LOCATOR[1]: True,
        CITY_SETTING_LOCATOR[1]: True,
        ZIP_CODE_SETTING_LOCATOR[1]: True,
        LATITUDE_SETTING_LOCATOR[1]: True,
        LONGITUDE_SETTING_LOCATOR[1]: True,
        TIMEZONE_SETTING_LOCATOR[1]: True,
        ISP_SETTING_LOCATOR[1]: True,
        ORG_SETTING_LOCATOR[1]: True,
        AS_SETTING_LOCATOR[1]: True
    }
}
